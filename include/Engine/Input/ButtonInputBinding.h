...
namespace gp1::input
{
	...
	{
	public:
		InputLocation      m_Location;  // The location of the button binding.
		ButtonInputType    m_InputType; // The button input type of the button binding.
		uint32_t           m_Button;    // The button that was altered.
		const std::string& m_Id;        // The id of the button binding.
	};
