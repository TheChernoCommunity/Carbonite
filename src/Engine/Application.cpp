...
//	- Maybe have m_Renderer.Render() get executed from a render thread as
//opposed to the window thread.
//
...
Mesh *TestEntity::GetMesh() const { return this->m_Mesh; }

Material *TestEntity::GetMaterial() const { return this->m_Material; }
