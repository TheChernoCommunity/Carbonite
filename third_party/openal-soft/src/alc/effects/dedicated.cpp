...
void DedicatedState::update(const ALCcontext *, const ALeffectslot *slot,
  ...
  if (slot->Params.EffectType == AL_EFFECT_DEDICATED_LOW_FREQUENCY_EFFECT) {
    const ALuint idx{!target.RealOut
...
void DedicatedState::process(const size_t samplesToDo,
  ...
  MixSamples({samplesIn[0].data(), samplesToDo}, samplesOut, mCurrentGains,
