...
using ResamplerFunc = const float *(*)(const InterpState *state,
...
#define VOICE_IS_AMBISONIC                                                     \
  (1u << 2) /* Voice needs HF scaling for ambisonic upsampling. */
#define VOICE_CALLBACK_STOPPED (1u << 3)
#define VOICE_IS_FADING                                                        \
  (1u << 4) /* Fading sources use gain stepping for smooth transitions. */
